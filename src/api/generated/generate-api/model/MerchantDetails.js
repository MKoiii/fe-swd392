...
class MerchantDetails {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('owner')) {
                obj['owner'] = UserDetails.constructFromObject(data['owner']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['owner']) { // data not null
          UserDetails.validateJSON(data['owner']);
        }
 ...
 * @member {Number} id
 */
MerchantDetails.prototype['id'] = undefined;

/**
 * @member {String} name
 */
MerchantDetails.prototype['name'] = undefined;

/**
 * @member {String} phone
 */
MerchantDetails.prototype['phone'] = undefined;

/**
 * @member {String} avatar
 */
MerchantDetails.prototype['avatar'] = undefined;

/**
 * @member {String} coverImage
 */
MerchantDetails.prototype['coverImage'] = undefined;

/**
 * @member {String} description
 */
MerchantDetails.prototype['description'] = undefined;

/**
 * @member {Number} provinceId
 */
MerchantDetails.prototype['provinceId'] = undefined;

/**
 * @member {String} provinceName
 */
MerchantDetails.prototype['provinceName'] = undefined;

/**
 * @member {Number} districtId
 */
MerchantDetails.prototype['districtId'] = undefined;

/**
 * @member {String} districtName
 */
MerchantDetails.prototype['districtName'] = undefined;

/**
 * @member {Number} wardId
 */
MerchantDetails.prototype['wardId'] = undefined;

/**
 * @member {String} wardName
 */
MerchantDetails.prototype['wardName'] = undefined;

/**
 * @member {String} addressDetails
 */
MerchantDetails.prototype['addressDetails'] = undefined;

/**
 * @member {String} addressNote
 */
MerchantDetails.prototype['addressNote'] = undefined;

/**
 * @member {module:model/MerchantDetails.StatusEnum} status
 */
 ...
 * @member {String} zalo
 */
MerchantDetails.prototype['zalo'] = undefined;

/**
 * @member {String} instagram
 */
MerchantDetails.prototype['instagram'] = undefined;
 ...
 */
MerchantDetails.prototype['representativeEmail'] = undefined;

/**
 * @member {String} representativePhone
 */
MerchantDetails.prototype['representativePhone'] = undefined;

/**
 * @member {String} idFront
 */
MerchantDetails.prototype['idFront'] = undefined;

/**
 * @member {String} idBack
 */
MerchantDetails.prototype['idBack'] = undefined;

/**
 * @member {module:model/UserDetails} owner
 */
MerchantDetails.prototype['owner'] = undefined;
