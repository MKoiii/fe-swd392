...
/**
 * The UserAddressInfoInfo model module.
 * @module model/UserAddressInfoInfo
 * @version 1.0.0
 */
class UserAddressInfoInfo {
    /**
     * Constructs a new <code>UserAddressInfoInfo</code>.
     * @alias module:model/UserAddressInfoInfo
     */
    constructor() { 
        
        UserAddressInfoInfo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserAddressInfoInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserAddressInfoInfo} obj Optional instance to populate.
     * @return {module:model/UserAddressInfoInfo} The populated <code>UserAddressInfoInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserAddressInfoInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>UserAddressInfoInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserAddressInfoInfo</code>.
     */
 ...
 * @member {Number} id
 */
UserAddressInfoInfo.prototype['id'] = undefined;

/**
 * @member {String} addressDetails
 */
UserAddressInfoInfo.prototype['addressDetails'] = undefined;

/**
 * @member {String} receiverFullName
 */
UserAddressInfoInfo.prototype['receiverFullName'] = undefined;

/**
 * @member {String} phone
 */
UserAddressInfoInfo.prototype['phone'] = undefined;

/**
 * @member {String} note
 */
UserAddressInfoInfo.prototype['note'] = undefined;

/**
 * @member {Number} provinceId
 */
UserAddressInfoInfo.prototype['provinceId'] = undefined;

/**
 * @member {String} provinceName
 */
UserAddressInfoInfo.prototype['provinceName'] = undefined;

/**
 * @member {Number} districtId
 */
UserAddressInfoInfo.prototype['districtId'] = undefined;

/**
 * @member {String} districtName
 */
UserAddressInfoInfo.prototype['districtName'] = undefined;

/**
 * @member {Number} wardId
 */
UserAddressInfoInfo.prototype['wardId'] = undefined;

/**
 * @member {String} wardName
 */
UserAddressInfoInfo.prototype['wardName'] = undefined;

/**
 * @member {Boolean} default
 */
UserAddressInfoInfo.prototype['default'] = undefined;
...
export default UserAddressInfoInfo;
